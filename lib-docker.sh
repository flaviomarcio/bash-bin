...
function dockerBuildCompose()
{
  ...
  export APPLICATION_DEPLOY_ENV_FILE=${__docker_build_env_file_docker}
  ...
  echo "export APPLICATION_DEPLOY_ENV_FILE=${APPLICATION_DEPLOY_ENV_FILE}"          >>${__docker_build_compose_sh_file}
